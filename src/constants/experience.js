...
export const exp2 = [
    {
      ...
      description:
        [
          "Mentored and Guided by Gaurav Sen aka 'GKCS'",
          "Created High-Level Design (HLD) documents for popular interview questions",
          "Wrote about 30+ artciles on topics like Designing Instagram NewsFeed, Hotstar Live Stream, DigiYatra Ticket Vault, YouTube Video, and much more",
          "Articles are currently live on InterviewReady's website at a paid subscription",
        ],
      link: "https://interviewready.io",
      date: "Dec-Jan 2023", 
      imageItem: "/assets/experience/interview-ready.png"
    },
  ]
...
export const exp3 = [
    {
      ...
      date: "Jun-Aug 2023",
      imageItem: "/assets/experience/c4gt.png"
...
export const exp4 = [
    {
      ...
      description: [
        "Built DAO Job Tracking website using React.js and Material UI",
        "Collaborated with Backend team to integrate APIs for fetching data",
        "Optimized the website for mobile responsiveness and accessibility",
        "Made the website performant by implementing lazy loading, code splitting, image and font optimizations strategies",
        "Implemented SEO strategies using React Header Library for better search engine ranking"
      ],
      link: "https://www.prodigalai.com/",
      date: "Mar-Jun 2023",
      imageItem: "/assets/experience/prodigal-ai.png"
    },
  ]
...
export const exp5 = [
    {
      ...
      link: "https://juppiterailabs.com",
      date: "Sep-Dec 2021",
      imageItem: "/assets/experience/juppiter.jpg",
    },
  ]
